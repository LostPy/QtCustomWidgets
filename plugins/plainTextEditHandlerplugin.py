...
from QtCustomWidgets.devTools.plainTextEditHandler import PlainTextEditHandler
from groups import GROUPS
 
 
class PlainTextEditHandlerPlugin(QPyDesignerCustomWidgetPlugin):
    """classe pour renseigner Designer sur le widget
       nom de classe à renommer selon le widget
    """
 
    def __init__(self, parent=None):
        super(PlainTextEditHandlerPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        """
        return PlainTextEditHandler(parent=parent)

    def name(self):
        """définit le nom du widget dans QtDesigner
        """
        return 'PlainTextEditHandler'
    ...
    def includeFile(self):
        ...
        """
        return 'QtCustomWidgets.devTools.plainTextEditHandler'
